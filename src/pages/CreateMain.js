...
function ChooseLanternColor({ handleCount, handleColorInput, val }) {
  return (
    <div>
      ...
      <ul className="pickLanternColor">
        <li className="pickLanternColor--item" id="lanter-1" />
        <li className="pickLanternColor--item" id="lanter-2" />
        <li className="pickLanternColor--item" id="lanter-3" />
        <li className="pickLanternColor--item" id="lanter-4" />
        <li className="pickLanternColor--item" id="lanter-5" />
      </ul>
